module.exports.config = {
  ...
  module.exports.handleReply = async function ({ event, api , args, handleReply, Users}){
    ...
    return api.sendMessage({body: `ㅤ\n╭┳≛✿≛╤╤ ────────►\n➤ Success\n➢ Here's Your photo ${name}\n╰┻≛✿≛╧╧═𝗜𝗺 🅟𝗶𝗸𝗮─►\nㅤ`, attachment : download}, event.threadID)
}
    }
}
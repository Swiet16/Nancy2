module.exports.config = {
	...
	hasPermssion: 1,
	credits: "𝙈𝙧 Aziz",
	description: " rankup for each group, user",
...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
  ...
  let pathImg = __dirname + "/noprefix/rankup/rankup1.png";
  ...
  fs.writeFileSync(pathImg, Buffer.from(getbackground, "utf-8"));
    ...
    ctx.drawImage(baseAvt1,24,95,125, 130);
...
module.exports.languages = {
	...
	"en": {
		...
		"levelup": "ㅤ\n ๛{name}​巛 ㅤ\n๛😘😘c̲̅o̲̅n̲̅g̲̅r̲̅a̲̅t̲̅u̲̅l̲̅a̲̅t̲̅i̲̅o̲̅n̲̅s̲̅🔥\n  ➢Y͠ӨЦ ᴬᴿᴱ ᴹᴼᴿᴱ ᴿᴼᴹᴬᴺᵀᴵᶜ ᴺᴼᵂ\n ＹＯＵＲ  ＨＯＴＮＥＳＳ\n           🔥🔥🔥༺ {level} ࿐\n ㅤ",
	}
}
""

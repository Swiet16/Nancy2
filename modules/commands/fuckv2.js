...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/lj6eMo8.jpeg", path);
}
...
async function makeImage({ one, two }) {
    ...
    batgiam_img.composite(circleOne.resize(15, 13), 0, 0).composite(circleTwo.resize(560, 560), 70, 190);
